                  ...
                  <div class="col-md-6">
                    <div class="login-form">
                      <p  style="text-align:center;font-size:25px;">
                        ...
                        <form action="<?php echo base_url()."register_historyandculturedata/History" ?>" method="post" enctype="multipart/form-data">
                        ...
                        foreach ($table_data as $key => $value) {
                          echo
                           "<tr>
                                    ...
                                    <div class='modal-dialog'>
                                      <div class='modal-content'>
                                        ...
                                        <p  style='text-align:center;font-size:25px;'>
                                          ...
                                          <form action=".base_url().'updatehistoryandculturedata/History'." method='post' enctype='multipart/form-data''>
                                          <div class='form-group'>
                            ...
                            <form action=".base_url().'deletehistoryandculturedata/History'." method='post' onsubmit='return ConfirmDelete()'>
