                  ...
                  <div class="col-md-6">
                    <div class="login-form">
                      <p  style="text-align:center;font-size:25px;">
                        ...
                        <form action="<?php echo "https://thinkkosovo.cleverapps.io/register_historyandculturedata/History" ?>" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <input class="au-input au-input--full" type="text" name="name" placeholder="History name" pattern='.{3,100}' required title='3 to 100 characters'>
                                  <span class='text_danger' style="color:red;"><?php echo form_error('name'); ?></span>
                            </div>
                            <div class="form-group">
                                <input class="au-input au-input--full" type="hidden" value="History" name="type_name" >
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input class="upload_image" type="file" name="image" placeholder="History Image" required>
                            </div>
                        ...
                        foreach ($table_data as $key => $value) {
                          echo
                           "<tr>
                                    ...
                                    <div class='modal-dialog'>
                                      <div class='modal-content'>
                                        ...
                                        <p  style='text-align:center;font-size:25px;'>
                                          ...
                                          <form action=".'https://thinkkosovo.cleverapps.io/updatehistoryandculturedata/History'." method='post' enctype='multipart/form-data''>
                                          <div class='form-group'>
                                          <input class='au-input au-input--full' type='text' name='idupdate' value=".$value['id']." hidden>
                                          </div>
                                          <div class='form-group'>
                                              <input class='au-input au-input--full' type='text' name='nameupdate'  value='".$value['name']."' placeholder='History name' pattern='.{3,100}' required title='3 to 100 characters'>
                                          </div>
                                          <div class='form-group'>
                                              <input class='au-input au-input--full' type='hidden' value='History' name='type_nameupdate' >
                                          </div>
                                          <div class='form-group'>
                                          ...
                                          <div class='main-section'>
                                            <p  style='color:red;'>If you edit any data you should update the history photo again</p>
                                          <div class='form-group'>
                                                <input class='upload_image' type='file' name='imageupdate' placeholder='History Image' required>
                                          </div>
                                          </div>
                                          <div class='register-link'>
                                              <p>
                            ...
                            <form action=".'https://thinkkosovo.cleverapps.io/deletehistoryandculturedata/History'." method='post' onsubmit='return ConfirmDelete()'>
