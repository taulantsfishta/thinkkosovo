                    ...
                    <div class="login-form">
                      <p  style="text-align:center;font-size:25px;">
                        ...
                        <form action="<?php echo base_url()."register_historyandculturedata/Nature" ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <input class="au-input au-input--full" type="hidden" value="Nature" name="type_name" >
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input class="upload_image" type="file" name="image" placeholder="Nature Image" required>
                            </div>
                                    ...
                                    <div class='modal-dialog'>
                                      <div class='modal-content'>
                                        ...
                                        <p  style='text-align:center;font-size:25px;'>
                                          ...
                                          <div class='form-group'>
                                              <input class='au-input au-input--full' type='text' name='nameupdate'  value='".$value['name']."' placeholder='Nature name' pattern='.{3,100}' required title='3 to 100 characters'>
                                          </div>
                                          <div class='form-group'>
                                              <input class='au-input au-input--full' type='hidden' value='Nature' name='type_nameupdate' >
                                          </div>
                                          <div class='form-group'>
                                          ...
                                          <div class='main-section'>
                                            <p  style='color:red;'>If you edit any data you should update the nature photo again</p>
                                          <div class='form-group'>
                                                <input class='upload_image' type='file' name='imageupdate' placeholder='Nature Image' required>
                                          </div>
                                          </div>
                                          <div class='register-link'>
                                              <p>
