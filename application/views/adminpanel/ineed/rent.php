...
<body class="animsition" onload="messageBox()">
                  ...
                  <div class="col-md-6">
                    <div class="login-form">
                      <p  style="text-align:center;font-size:25px;">
                        ...
                        <form action="<?php echo "https://thinkkosovo.cleverapps.io/register_rent/Rent" ?>" method="post" enctype="multipart/form-data">
                          <div class="form-group">
                            ...
                            <div class="form-group">
                            <input class="au-input au-input--full" type="text" name="name" placeholder="Rent Name" pattern='.{3,100}' required title='3 to 100 characters'>
                            ...
                            <div class="form-group">
                                <input class="au-input au-input--full" type="text" name="type_ineed" value="Rent" hidden>
                ...
                <div class="col-md-6">
                  <div class='container'>
                    ...
                    <div class='row'>
                      ...
                      <div class='col-md-8'>
                          <div class="image">
                          <img src="<?php echo asset_url()."images/icon/rent.png";?>" alt="rent" />
                          </div>
                      </div>
                        ...
                        foreach ($table_data as $key => $value) {
                          echo
                           "<tr>
                                    ...
                                    <div class='modal-dialog'>
                                      <div class='modal-content'>
                                        ...
                                        <p  style='text-align:center;font-size:25px;'>
                                          ...
                                          <form action=".'https://thinkkosovo.cleverapps.io/updaterentdata/Rent'." method='post' enctype='multipart/form-data''>
                                                <div class='form-group'>
                                                ...
                                                <div class='form-group'>
                                                <input class='au-input au-input--full' type='text' name='nameupdate' value='".$value['name']."' placeholder='Rent Name' pattern='.{3,100}' required title='3 to 100 characters'>
                                                </div>
                                                <div class='form-group'>
                                                ...
                                                <div class='form-group'>
                                                    <input class='au-input au-input--full' type='text' name='type_ineedupdate' value='Rent' hidden>
                                                </div>
                                                <div class='main-section'>
                                                  <p  style='color:red;'>If you edit any data you should update the rent photo again</p>
                                                <div class='form-group'>
                                                      <input class='upload_image' type='file' name='imageupdate' placeholder='Rent Image' required>
                                                </div>
                                                </div>
                                                <div class='register-link'>
                                                    <p>
                            ...
                            <form action=".'https://thinkkosovo.cleverapps.io/deleteineeddata/Rent'." method='post' onsubmit='return ConfirmDelete()'>
    ...
    <script>
        function messageBox(){
          ...
          var str                   = error_message_update +',' + nameupdate + ',' + telephoneupdate + ',' + cityupdate + ',' + locationupdate;
          var array                 = str.split(",");
          var newArray              = [];
          if('' != return_message_update){
            alertify.alert('Update Message', return_message_update);
          }else if(('' == error_message_update) && ('' == nameupdate) && ('' == telephoneupdate) && ('' == cityupdate) && ('' == locationupdate)){
            return ;
          }else{
