                  ...
                  <div class="col-md-6">
                    <div class="login-form">
                      <p  style="text-align:center;font-size:25px;">
                        Register new coffe service
                      </p>
                        <span class='col-md-12' style="color:#63C76A;font-size:20px;"><?php echo $return_message;?></span>
                        <form action="<?php echo "https://thinkkosovo.cleverapps.io/register_coffe/Coffe" ?>" method="post" enctype="multipart/form-data">
                          <div class="form-group">
                            ...
                            <div class="form-group">
                            <input class="au-input au-input--full" type="text" name="name" placeholder="Coffe Service Name" pattern='.{3,100}' required title='3 to 100 characters'>
                            ...
                            <div class="form-group">
                                <textarea class="textareaclass" style ="width:100%;"  name="description" placeholder="Description" pattern='.{3,500}' required title='3 to 500 characters'></textarea>
                            ...
                            <div class="form-group">
                                <input class="au-input au-input--full" type="text" name="type_ineed" value="Coffe" hidden>
                                <span class='text_danger' style="color:red;"><?php echo form_error('type_ineed'); ?></span>
                            </div>
                            <div class='form-group'>
                                <input class='au-input au-input--full' type='text' name='url' placeholder='Website of Coffe (Optional)' pattern='.{3,100}' title='3 to 100 characters'>
                                <span class='text_danger' style='color:red;'><?php echo form_error('url'); ?></span>
                            </div>
                            <div class='form-group'>
                                <input class='au-input au-input--full' type='text' name='email' placeholder='Email of Coffe (Optional)' pattern='.{3,100}' title='3 to 100 characters'>
                            ...
                            <div class="main-section">
                              ...
                              <div class="form-group">
                                  <input class="upload_image" type="file" name="image" placeholder="Coffe Image" required>
                              </div>
                            </div>
                ...
                <div class="col-md-6">
                  <div class='container'>
                    ...
                    <div class='row'>
                      <div class='col-md-6'>
                          <div class="image">
                          <img src="<?php echo asset_url()."images/icon/coffe.png";?>" alt="event" />
                          </div>
                      </div>
                      <div class='col-md-6'>
                        <div class="image">
                        <img src="<?php echo asset_url()."images/icon/coffe1.png";?>" alt="event" />
                        </div>
                      </div>
              ...
              <div class='row'>
                <div class='col-md-12'>
                  <table id="example" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                    ...
                    <thead>
                      <tr>
                        <th class="th-sm">Coffe Service Name</th>
                        ...
                        foreach ($table_data as $key => $value) {
                          echo
                           "<tr>
                                    ...
                                    <div class='modal-dialog'>
                                      <div class='modal-content'>
                                        ...
                                        <p  style='text-align:center;font-size:25px;'>
                                          ...
                                          <form action=".'https://thinkkosovo.cleverapps.io/updatecoffedata/Coffe'." method='post' enctype='multipart/form-data''>
                                          <div class='form-group'>
                                          ...
                                          <div class='form-group'>
                                            ...
                                            <div class='form-group'>
                                            <input class='au-input au-input--full' type='text' name='nameupdate' value='".$value['name']."' placeholder='Coffe Service Name' pattern='.{3,100}' required title='3 to 100 characters'>
                                            </div>
                                            <div class='form-group'>
                                            ...
                                            <div class='form-group'>
                                                <textarea class='textareaclass' style ='width:100%;'  name='descriptionupdate' placeholder='Description' pattern='.{3,500}' required title='3 to 500 characters'>".$value['description']."</textarea>
                                            </div>
                                            <div class='form-group'>
                                            ...
                                            <div class='form-group'>
                                                <input class='au-input au-input--full' type='text' name='type_ineedupdate' value='Coffe' hidden>
                                            </div>
                                            <div class='form-group'>
                                                <input class='au-input au-input--full' type='text' name='urlupdate' value='".$value['url']."'  placeholder='Website of Coffe (Optional)' pattern='.{3,100}' title='3 to 100 characters'>
                                                <span class='text_danger' style='color:red;'><?php echo form_error('url'); ?></span>
                                            </div>
                                            <div class='form-group'>
                                                <input class='au-input au-input--full' type='text' name='emailupdate' value='".$value['email']."' placeholder='Email of Coffe (Optional)' pattern='.{3,100}' title='3 to 100 characters'>
                                                <span class='text_danger' style='color:red;'><?php echo form_error('email'); ?></span>
                                            </div>
                                            <div class='form-group'>
                                            ...
                                            <div class='main-section'>
                                              ...
                                              <div class='form-group'>
                                                  <input class='upload_image' type='file' name='imageupdate' placeholder='Coffe Image' required>
                                              </div>
                                            </div>
                                            <div class='main-section'>
                            ...
                            <form action=".'https://thinkkosovo.cleverapps.io/deleteineeddata/Coffe'." method='post' onsubmit='return ConfirmDelete()'>
