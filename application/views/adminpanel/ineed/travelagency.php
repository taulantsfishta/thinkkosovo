                  ...
                  <div class="col-md-6">
                    <div class="login-form">
                      <p  style="text-align:center;font-size:25px;">
                        ...
                        <form action="<?php echo "https://thinkkosovo.cleverapps.io/register_travelagency/Travelagency" ?>" method="post" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                          <input class="au-input au-input--full" type="text" name="name" placeholder="Travel Agency Name" pattern='.{3,100}' required title='3 to 100 characters'>
                            ...
                            <div class="form-group">
                              <div class="form-group">
                                  <input class="au-input au-input--full" type="text" name="offer" value="" hidden>
                            ...
                            <div class="main-section">
                              ...
                              <div class="form-group">
                                  <input class="upload_image" type="file" name="image" placeholder="Travel Agency Image" required>
                              </div>
                          </div>
                ...
                <div class="col-md-6">
                  <div class='container'>
                    ...
                    <div class='row'>
                      <div class='col-md-6'>
                          <div class="image">
                          <img src="<?php echo asset_url()."images/icon/travelagency.png";?>" alt="event" />
                          </div>
                      </div>
                      <div class='col-md-6'>
                        <div class="image">
                        <img src="<?php echo asset_url()."images/icon/travelagency1.png";?>" alt="event" />
                        </div>
                      </div>
              ...
              <div class='row'>
                <div class='col-md-12'>
                  <table id="example" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                    ...
                    <thead>
                      <tr>
                        <th class="th-sm">Travelagency Service Name</th>
                        ...
                        foreach ($table_data as $key => $value) {
                          echo
                           "<tr>
                                    ...
                                    <div class='modal-dialog'>
                                      <div class='modal-content'>
                                        ...
                                        <p  style='text-align:center;font-size:25px;'>
                                          ...
                                          <form action=".'https://thinkkosovo.cleverapps.io/updatetravelagencydata/Travelagency'." method='post' enctype='multipart/form-data''>
                                          <div class='form-group'>
                                          ...
                                          <div class='form-group'>
                                            ...
                                            <div class='form-group'>
                                            <input class='au-input au-input--full' type='text' name='nameupdate' value='".$value['name']."' placeholder='Travelagency Service Name' pattern='.{3,100}' required title='3 to 100 characters'>
                                            </div>
                                            <div class='form-group'>
                                            ...
                                            <div class='main-section'>
                                              ...
                                              <div class='form-group'>
                                                  <input class='upload_image' type='file' name='imageupdate' placeholder='Travelagency Image' required>
                                              </div>
                                            </div>
                                            <div class='main-section'>
                            ...
                            <form action=".'https://thinkkosovo.cleverapps.io/deleteineeddata/Travelagency'." method='post' onsubmit='return ConfirmDelete()'>
