                  ...
                  <div class="col-md-6">
                    <div class="login-form">
                      <p  style="text-align:center;font-size:25px;">
                        ...
                        <form action="<?php echo "https://thinkkosovo.cleverapps.io/register_taxi/Taxi" ?>" method="post" enctype="multipart/form-data">
                        ...
                        foreach ($table_data as $key => $value) {
                          echo
                           "<tr>
                                    ...
                                    <div class='modal-dialog'>
                                      <div class='modal-content'>
                                        ...
                                        <p  style='text-align:center;font-size:25px;'>
                                          ...
                                          <form action=".'https://thinkkosovo.cleverapps.io/updatetaxidata/Taxi'." method='post' enctype='multipart/form-data''>
                                                <div class='form-group'>
                            ...
                            <form action=".'https://thinkkosovo.cleverapps.io/deleteineeddata/Taxi'." method='post' onsubmit='return ConfirmDelete()'>
