                  ...
                  <div class="col-md-6">
                    <div class="login-form">
                      <p  style="text-align:center;font-size:25px;">
                        ...
                        <form action="<?php echo base_url()."register_photodata/Photo" ?>" method="post" enctype="multipart/form-data">

                            <div class="form-group">
                                <input class="au-input au-input--full" type="text" name="place_name" placeholder="Place Name">
                                <span class='text_danger' style="color:red;"><?php echo form_error('place_name'); ?></span>
                            </div>
                            <div class="form-group">
                            <input class="au-input au-input--full" type="text" name="city" placeholder="City">
                                <span class='text_danger' style="color:red;"><?php echo form_error('city'); ?></span>
                            </div>
                            <div class="form-group">
                            <input class="au-input au-input--full" type="text" name="place_location" placeholder="Place's Location">
                                <span class='text_danger' style="color:red;"><?php echo form_error('place_location'); ?></span>
                            </div>
                            <div class="form-group">
                                <textarea class="au-input au-input--full" style ="width:100%;"  name="description" placeholder="Description"></textarea>
                                <span class='text_danger' style="color:red;"><?php echo form_error('description'); ?></span>
                            </div>
                            <div class="form-group">
                                <input class="upload_image" type="file" name="image_place" placeholder="Place Image" >
                            </div>
                ...
                <div class="col-md-6">
                  <div class='container'>
                    ...
                    <div class='row'>
                      <div class='col-md-6'>
                          <div class="image">
                          <img src="<?php echo asset_url()."images/icon/photo.png";?>" alt="history&culture" />
                          </div>
                      </div>
                      <div class='col-md-6'>
                        <div class="image">
                        <img src="<?php echo asset_url()."images/icon/photo1.png";?>" alt="history&culture" />
                        </div>
                      </div>
                  ...
                  <table id="example" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th class="th-sm">Place Location</th>
                        <th class="th-sm">Image Name</th>
                        <th class="th-sm">Info. Added Date</th>
                        ...
                        foreach ($table_data as $key => $value) {
                          echo
                           "<tr>
                            ...
                            <td>".$value['city']."</td>
                            <td>".$value['place_location']."</td>
                            <td>".$value['image_place']."</td>
                            <td>".$value['created_at']."</td>
                            <form action=".base_url().'deletephotodata/Photo'." method='post' onsubmit='return ConfirmDelete()'>
